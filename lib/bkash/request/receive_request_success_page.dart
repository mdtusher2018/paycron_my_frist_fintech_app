...
class ReceiveRequestSuccessPage extends StatelessWidget {
  const ReceiveRequestSuccessPage({super.key});
  ...
  Widget successIcon() {
    return Container(
      ...
      child: Icon(Icons.request_page, color: Colors.blue, size: 60.sp),
    );
  }
  ...
  Widget requestCard() {
    return Container(
      ...
      child: Column(
        children: [
          const CommonText("Amount Requested", size: 13, color: Colors.grey),
          ...
          Row(
            ...
            children: const [
              CommonText("Request ID", size: 12, color: Colors.grey),
              CommonText("#RQ984534"),
            ],
          ),
